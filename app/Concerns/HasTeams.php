...
trait HasTeams
{
    ...
    {
        $role = $this->teamRole($team);
        $abilities = app(TeamAuthorizationService::class)->permissionMap($this, $team);
        ...
        return new TeamPermissions(
            ...
            canManageMembers: $role?->hasPermission(TeamPermission::TeamMembersManage) ?? false,
            abilities: $abilities,
        );
    }
    ...
    {
        return app(TeamAuthorizationService::class)->can($this, $team, $permission);
    }
}
