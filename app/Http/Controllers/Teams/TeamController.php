...
class TeamController extends Controller
{
     ...
     */
    public function index(Request $request, BillingAccountService $billingAccounts, PlanRegistry $plans): Response
    {
        $user = $request->user();
        ...
        return Inertia::render('teams/index', [
            ...
            'workspaceBilling' => [
                'free_available' => $billingAccounts->canCreateFreeTeam($billingAccounts->forUser($user)),
                'plans' => array_map(fn ($plan): array => $plans->toClientArray($plan), $plans->publicPlans()),
            ],
        ]);
    }
