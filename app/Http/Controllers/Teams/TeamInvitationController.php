...
class TeamInvitationController extends Controller
{
    ...
    public function accept(
        ...
        DB::transaction(function () use ($user, $invitation, $entitlements) {
            $team = Team::query()->lockForUpdate()->findOrFail($invitation->team_id);

            if (! $team->memberships()->where('user_id', $user->id)->exists()) {
                $entitlements->assertCanConsume($team, PlanLimit::TeamMembers, 'email');
            }
