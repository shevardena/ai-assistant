...
export function AppHeader({ breadcrumbs = [] }: Props) {
    ...
    const botsUrl = currentTeam ? botsIndex(currentTeam.slug) : '/';
    const dataSourcesUrl = currentTeam
        ? dataSourcesIndex(currentTeam.slug)
        : '/';
    const datasetsUrl = currentTeam ? datasetsIndex(currentTeam.slug) : '/';
    const notificationsUrl = currentTeam
        ? notificationsIndex(currentTeam.slug)
        : '/';
    const unreadNotifications =
        page.props.currentTeamUnreadNotificationsCount ?? 0;
