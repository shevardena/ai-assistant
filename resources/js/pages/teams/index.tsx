...
import type { Team, WorkspaceBilling } from '@/types';
...
export default function TeamsIndex({ teams, workspaceBilling }: Props) {
    ...
    return (
        <>
            <Head title={t('common.teams')} />

            <h1 className="sr-only">{t('common.teams')}</h1>
            ...
            <div className="flex flex-col space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <CreateTeamModal workspaceBilling={workspaceBilling}>
